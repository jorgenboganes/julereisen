...
const data: OppgaveEntry[] = [
    ...
    { dag: 18, beskrivelse: "I Melbourne blir du invitert på middag med fire personer. Den første forteller hun blant annet var løytnant i en stjernereise og har et lite himmellegeme oppkalt i sitt navn. Den neste er kjent som tidlig formidler av julesønnens ord. Den tredje har runde solbriller på seg selv om det er kveld og sier han var medlem av svart hvile. Den siste gjesten sier han er ung til sinns og blir kalt arketype. Han vil ta deg med til sitt land, som ikke finnes på verdenskartet. Som vanlig i på denne reisens middagselskap, har også deltakerne denne gangen et fiffig fellestrekk og viktig ordning.", hint: "Kanskje metrikkbegrepet alliterasjon kan hjelpe deg i dagens oppgave?", svar: "Peter Pans Neverland"},
