...
const data: TopplisteEntry[] = [
    { navn: "Thor Magne Seland", score: 69} ,
    { navn: "Joakim D", score: 69} ,
    { navn: "Dammen & Madammen", score: 69} ,
    { navn: "Yri Helene Ljosdal", score: 68} ,
    { navn: "Nora Grøtting", score: 68} ,
    { navn: "Aina", score: 67} ,
    { navn: "Tone&Mensamedlemmet", score: 65} ,
    { navn: "Adam", score: 65} ,
    { navn: "Magnus Steigedal", score: 60} ,
    { navn: "Åse Mari og Kjell Ole", score: 59} ,
    { navn: "Hildur Nautnes", score: 59} ,
    { navn: "Helge boganes", score: 59} ,
    { navn: "Runar og Vivian", score: 58} ,
    { navn: "Lars Lind", score: 58} ,
    { navn: "Vidar", score: 57} ,
    { navn: "Åge Andersen", score: 49} ,
    { navn: "Tonje HG", score: 49} ,
    { navn: "Sigve", score: 49} ,
    { navn: "Mia Schrøder", score: 49} ,
    { navn: "Marit Granhaug", score: 49} ,
    { navn: "Lise Rådmannsøy", score: 49} ,
    { navn: "Torill Lundgren", score: 48} ,
    { navn: "Helene Jakobia", score: 48} ,
    { navn: "Anne-Kristin Solheim", score: 48} ,
    { navn: "Vilde Aakre Lie", score: 47} ,
    { navn: "SpeedyPer", score: 47} ,
    { navn: "Kjersti Aakre", score: 47} ,
    { navn: "Karoline & Simen", score: 47} ,
    { navn: "Elisabeth", score: 40} ,
    { navn: "Øyvind By Rise", score: 39} ,
    { navn: "Kris og Matta", score: 39} ,
    { navn: "Ida Jensen", score: 39} ,
    { navn: "Daniel King", score: 39} ,
    { navn: "Olve Ellingsen", score: 37} ,
    { navn: "Trygve By Rise", score: 30} ,
    { navn: "Tonje Nedal", score: 30} ,
    { navn: "Knut og merete", score: 29} ,
    { navn: "Bente Renée Holmstad", score: 29} ,
    { navn: "Lassepasse", score: 28} ,
    { navn: "Konrad Slinning", score: 28} ,
    { navn: "Kirsti M Olsen", score: 28} ,
    { navn: "Øystein Garli Dragset", score: 20} ,
